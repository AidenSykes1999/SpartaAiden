...
private String email;
    ...
    public boolean equals(Object o) {
        ...
        Customer customer = (Customer) o; // typecast from object to customer
        return Objects.equals(firstName, customer.firstName) && Objects.equals(lastName, customer.lastName)
        && Objects.equals(email, customer.email);
    }

    @Override
    // for two objects which are equal,(according to .equals()) the hashCode values should be the same
    public int hashCode() {
